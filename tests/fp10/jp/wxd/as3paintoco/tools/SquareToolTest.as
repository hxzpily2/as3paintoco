package jp.wxd.as3paintoco.tools 
{
	...
	public class SquareToolTest 
	{
		...
		{
			_tool = new SquareTool();
		}
		
		test function constructor():void
		{
			assertTrue(_tool is SquareTool, "check whether new method returns instance of 'SquareTool'.");
		}
		...
		test function properties():void
		{
			...
			assertTrue(_tool.isDrawable, "check whether SquareTool is drawable or not");
		}
