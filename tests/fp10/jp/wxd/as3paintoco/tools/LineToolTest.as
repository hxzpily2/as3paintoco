package jp.wxd.as3paintoco.tools 
{
	...
	public class LineToolTest 
	{
		...
		{
			assertTrue(_tool is LineTool, "check whether new method returns instance of 'LineTool'.");
		}
		...
		test function properties():void
		{
			...
			assertTrue(_tool.isDrawable, "check whether LineTool is drawable or not");
		}
